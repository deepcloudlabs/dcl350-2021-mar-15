...
public class EmployeeEntity {
	...
	public String toString() {
		return "EmployeeEntity [kimlikNo=" + kimlikNo + ", fullname=" + fullname + ", salary=" + salary + ", currency="
				...
				+ jobType + ", getKimlikNo()=" + getKimlikNo() + ", getFullname()=" + getFullname() + ", getSalary()="
				+ getSalary() + ", getCurrency()=" + getCurrency() + ", getIban()=" + getIban() + ", getBirthYear()="
				+ getBirthYear() + ", getDepartment()=" + getDepartment() + ", getJobType()=" + getJobType()
				+ ", getPhoto()=" + Arrays.toString(getPhoto()) + ", hashCode()=" + hashCode() + ", getClass()="
